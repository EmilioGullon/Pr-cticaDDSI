...
from .views import ListaMarketing,agregar_socio, eliminar_socio, buscar_socio, modificar_socio, mostrar_socio, buscar_anuncio, mostrar_anuncio, agregar_anuncio, eliminar_anuncio, modificar_anuncio, anuncio_de_producto, eliminar_el_producto 
