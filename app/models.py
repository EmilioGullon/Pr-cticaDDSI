...
class Gasto(models.Model):
    ...
    CantG = models.DecimalField(max_digits=12, decimal_places=2, null=True, validators=[MinValueValidator(limit_value=0.01, message='El campo debe ser un número mayor que 0')])
