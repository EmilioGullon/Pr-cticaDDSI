    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('CantG', models.DecimalField(decimal_places=2, max_digits=8, validators=[django.core.validators.MinValueValidator(limit_value=0.01, message='El campo debe ser un número mayor que 0')])),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FechaN', models.DateField(default=django.utils.timezone.now)),
                ('Nomina', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.nomina_tiene')),
                ('Num_factura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.gaston')),
            ],
            options={
                'unique_together': {('FechaN', 'Num_factura'), ('Nomina', 'FechaN')},
            },
        ),
        migrations.CreateModel(
            name='conlleva',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('FechaP', models.DateField(default=django.utils.timezone.now)),
                ('Cant', models.PositiveIntegerField()),
                ('Num_factura', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.gastop')),
                ('Prod', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='app.producto')),
            ],
            options={
                'unique_together': {('FechaP', 'Prod'), ('Num_factura', 'FechaP')},
            },
        ),
